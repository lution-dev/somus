...
#### T-AD-21: Fluxo: Inst�ncias Mensais + Override de Valor por M�s
**Tipo:** Redesign / Feature
**Arquivo:** src/pages/Fluxo.tsx + src/stores/useAppStore.ts
**Crit�rios:**
- [x] Redesign da p�gina Fluxo: lista unificada (fixas, vari�veis, entradas)
- [x] Filtros por tipo: Tudo, Sa�das, Entradas
- [x] monthlyAmountOverrides no tipo SaidaFixa (store v13)
- [x] Novo EditMonthlyAmountModal para editar valor apenas no m�s corrente
- [x] Integra��o de sa�das vari�veis no fluxo do m�s atual
- [x] Action sheet com atalho r�pido Editar valor deste m�s
**Status:** ? Conclu�do

---

#### T-AD-22: Fluxo/Home: Refinamento de Pend�ncias e �cones
**Tipo:** UX / Visual
**Arquivo:** src/pages/Fluxo.tsx + src/pages/Home.tsx
**Crit�rios:**
- [x] Home: Pr�ximos dias agora usa valor efetivo (overrides)
- [x] Home: Trocar �cone de despesa pendente para AlertCircle
- [x] Fluxo: Substituir pontos coloridos por �cones de status (Check/Alerta)
- [x] Fluxo: Restaurar divis�es Pendentes vs Lan�amentos do m�s
- [x] Fluxo: Anima��o de glow nos itens pendentes
**Status:** ? Conclu�do

---

#### T-AD-23: Home: Exibi��o de Pend�ncias Atrasadas
**Tipo:** UX / Feature
**Arquivo:** src/pages/Home.tsx
**Crit�rios:**
- [x] Incluir itens atrasados (days < 0) na se��o Pr�ximos dias
- [x] Janela de exibi��o aumentada para 15 dias
- [x] Label corrigido: Atrasado h� Xd
- [x] Limite de itens na Home aumentado de 5 para 10
**Status:** ? Conclu�do

---

#### T-AD-24: Fix: C�lculo de dias para itens atrasados
**Tipo:** Bug / UX
**Arquivo:** src/lib/calculations.ts
**Crit�rios:**
- [x] Corrigido getDaysUntil para n�o saltar automaticamente para o pr�ximo m�s
- [x] Normaliza��o de hor�rio para c�lculos de dias inteiros precisos
- [x] Suporte a dias negativos para exibi��o de atrasos (Atrasado h� Xd)
**Status:** ? Conclu�do

---

#### T-AD-25: Fluxo: Recurso 'Pular M�s' para Custos Fixos
**Tipo:** UX / Feature
**Arquivo:** src/pages/Fluxo.tsx + src/stores/useAppStore.ts
**Crit�rios:**
- [x] Adicionar skippedMonths � interface SaidaFixa
- [x] Action skipSaidaFixaForMonth na store
- [x] Op��o 'Pular este m�s' no ItemActionSheet do Fluxo
...
#### T-AD-26: Fluxo: M�s por extenso na Navbar
**Tipo:** Visual
**Arquivo:** src/pages/Fluxo.tsx
**Crit�rios:**
- [x] Alterar formato do m�s de 'short' para 'long' na Navbar do Fluxo
**Status:** ? Conclu�do

---

#### T-AD-27: Fluxo: Padroniza��o de espa�amentos (UI)
**Tipo:** Visual / Polimento
**Arquivo:** src/pages/Fluxo.tsx
**Crit�rios:**
- [x] Padronizar espa�amentos entre Choice, Busca e Lista para 16px
**Status:** ? Conclu�do
