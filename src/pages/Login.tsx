...
const FEATURES = [
  { icon: TrendingUp, label: 'Controle financeiro', desc: 'Gerencie entradas e caixinhas' },
  { icon: Users,      label: 'Feito para casais',    desc: 'Planejamento a dois, sincronizado' },
  { icon: Lock,       label: 'Seguro na nuvem',      desc: 'Seus dados sempre protegidos' },
]
    ...
    <div style={{
      ...
      >
        <div style={{
          ...
          borderRadius: 24,
          background: 'rgba(35,132,255,0.08)',
      ...
      <motion.div
        ...
        style={{
          ...
          marginBottom: 40, width: '100%', maxWidth: 340,
        }}
      >
        {FEATURES.map(({ icon: Icon, label, desc }) => (
          ...
          >
            <div style={{
              ...
              background: 'linear-gradient(135deg, rgba(35,132,255,0.12) 0%, rgba(139,92,246,0.08) 100%)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              flexShrink: 0,
            }}>
      ...
      >
        ...
        >
          {isLoading ? (
            <Loader2 size={20} style={{ animation: 'somus-spin 0.8s linear infinite' }} />
          ) : (
            <GoogleLogo />
          )}
          Entrar com Google
      ...
      >
        Somus © {new Date().getFullYear()} · Feito com ♥
      </motion.p>

      {/* Keyframes */}
      <style>{`
        @keyframes somus-spin {
